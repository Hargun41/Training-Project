...
function randomParagraph() {
    ...
    //getting random item from the paragraphs array, splitting all chatacters
...
function initTyping() {
    ...
    if (typedChar == null) {
        ...
        if (characters[charIndex].innerText === typedChar) {
            ...
            // correct class else increment the mistakes and add the incorrct class
            characters[charIndex].classList.add("correct");
        } else {
            mistakes++;
            characters[charIndex].classList.add("incorrect");
        }
        charIndex++; // increment charIndex either user can typed correct or incorrect character.
...
function resetGame() {
    ...
    // resetting each variables and elements value to defautl
    randomParagraph();
    inpField.value = "";
    clearInterval(timer);
    timeLeft = maxTime,
